...
// post 表单
// options={buttion:"#btnOk",url:"",begin:function(data){},end:function(ret){},error:function(ret){}}
...
//初始化JQGRID
function initJqGrid(selector, options) {
    try {
        var _options = {
            viewrecords: true,
            height: 400,
...
function gotoUrl(href) {
    ...
    if (ret === false) {
        ...
        $.ajax({ url: url, data: { _: Math.random() } }).done(function (result) {
