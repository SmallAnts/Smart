...
namespace Smart.Core
{
    ...
    public static class NativeMethods
    {
        ...
        /// 合成一次击键事件
        /// <para>示例 Ctrl+V:</para>
        /// <para>keybd_event(17, 0, 0, 0); //模拟按下ctrl键 </para>
        /// <para>keybd_event(86, 0, 0, 0); //模拟按下v键  </para>
        /// <para>keybd_event(86, 0, 2, 0); //松开按键v </para>
        /// <para>keybd_event(17, 0, 2, 0); //松开按键ctrl </para>
        /// </summary>
        ...
        /// 该函数将指定的消息发送到一个或多个窗口。
        /// </summary>
        /// <param name="wnd">要接收消息的那个窗口的句柄</param>
        /// <param name="Msg">消息的标识符</param>
        /// <param name="wParam"></param>
        /// <param name="lParam"></param>
        /// <returns></returns>
        [DllImport("User32.dll", EntryPoint = "SendMessage")]
        public static extern int SendMessage(IntPtr wnd, int Msg, int wParam, ref CopyDataStruct lParam);
        ...
        /// 网络链接状态
        /// </summary>
        /// <param name="lpdwFlags">网络连接状态标识</param>
        ...
        public struct Point
        {
            ...
            /// <summary>
            /// 初始化 SmallAnts.Windows.Win32.POINT 结构的新实例。
            /// </summary>
        ...
        public struct Rect
        {
            ...
            /// <summary>
            /// 初始化 SmallAnts.Windows.Win32.RECT 结构的新实例。
            /// </summary>
        ...
        public struct Size
        {
            ...
            /// <summary>
            /// 初始化 SmallAnts.Windows.Win32.SIZE 结构的新实例。
            /// </summary>
        ...
        public struct CopyDataStruct
        {
            ...
            /// <returns></returns>
            public static CopyDataStruct FromIntPtr(IntPtr intptr)
            {
                var cds = (CopyDataStruct)Marshal.PtrToStructure(intptr, typeof(CopyDataStruct));
                return cds;
            }
            /// <summary>
            ///  保存一个数值, 可以用来作标志等
        ...
        /// <param name="nIndex">需要设置的相关信息的类型</param>
        ...
        /// </summary>
        /// <param name="hwnd">目标窗口的句柄</param>
        public static void SetNoActivateStyle(IntPtr hwnd)
        {
